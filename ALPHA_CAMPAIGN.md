...
### 시점 7 — Wave3 잔차신호 · 2026-06-17 19:08~ (KR 완료, US 진행 중)
idio-vol + 다호라이즌 residual momentum를 mn_norm 위에 추가.
| 시장 | 대상 | alpha/yr | IC | conc5 | 비고 |
|---|---|---|---|---|---|
| KR | mn_norm | 3.49±2.82 | 0.0056 | 511% | 기준 |
| KR | **mn_w3** | **11.48±0.50** | 0.0071 | **135%** | IC↑·분산↓·집중↓ (유망) |
| US | mn_w3 | — | — | — | *진행 중* |
> KR은 IC↑+분산 대폭↓(±0.5)+집중 대폭↓(135 vs 511). US cross-market 확정 후 판정.
